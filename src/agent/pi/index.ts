...
import type { AgentProvider, AgentProviderConfig, AgentRunOptions, AgentRunResult } from "../types.js";
...
export class PiAgentProvider implements AgentProvider {
  ...
  async init(config: AgentProviderConfig): Promise<void> {
  ...
  async run(options: AgentRunOptions): Promise<AgentRunResult> {
    if (!authStorage) throw new Error("PiAgentProvider not initialized");
