...
- Shows cached Anthropic API rate limits via `@bot status` (no agent needed — reads from last API response). Automatically warns in responses when usage exceeds 98%.
